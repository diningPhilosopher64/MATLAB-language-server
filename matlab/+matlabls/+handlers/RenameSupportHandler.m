classdef (Hidden) RenameSupportHandler < matlabls.handlers.FeatureHandler
    % RENAMENHANDLER The feature handler to support symbol renaming.

    % Copyright 2024 The MathWorks, Inc.

    properties (Access = private)
        ResolvePathRequestChannel = '/matlabls/rename/resolvePath/request'
        ResolvePathResponseChannel = '/matlabls/rename/resolvePath/response'
    end

    methods
        function this = RenameSupportHandler ()
